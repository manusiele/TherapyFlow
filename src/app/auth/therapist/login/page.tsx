  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userRole !== 'therapist') {
        setError('This login is for therapists only. Please use the patient login.')
        await auth.signOut()
        setIsLoading(false)
        return
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-slate-50 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-800 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="mt-6 flex items-center justify-center space-x-2">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Manage your practice</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 border border-purple-100 dark:border-purple-900/50">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-6">Sign in to access your dashboard</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pr-12 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password" className="text-sm text-purple-600 dark:text-purple-400 hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link href="/auth/therapist/signup" className="text-purple-600 dark:text-purple-400 font-medium hover:underline">
          ...
          <div className="mt-4 text-center">
            <Link href="/auth/patient/login" className="text-sm text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400">
