        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-semibold text-slate-900">TherapyFlow</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card group hover:scale-105 animate-slide-up">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Session Management</h3>
            ...
            <div className="card group hover:scale-105 animate-slide-up" style={{animationDelay: '0.1s'}}>
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Progress Analytics</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="card group hover:scale-105 animate-slide-up" style={{animationDelay: '0.2s'}}>
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Secure Communication</h3>
              <p className="text-slate-600 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="animate-fade-in">
              ...
              <div className="text-slate-600">Active Therapists</div>
            </div>
